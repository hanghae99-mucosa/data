...
class UserFaker():
    @logging_time
    def create_user_dataset(self, start, num):
        user_class_list = []
        ...
        for i in range(start, start + num):
            ...
            password = "$2b$12$ED5RKqgYnGZv10y3Wz56KuCtVcWsPcib6.oTLe7nw4a1Iyy2kgODe"
            # USER가 0, ADMIN 1
...
if __name__ == "__main__":
    ...
    user_class_list = user_faker.create_user_dataset(10, 100)
